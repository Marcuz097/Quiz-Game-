      ...
      const showNamePrompt = () => {
        container.innerHTML = `
                      <div style="text-align: center; margin-top: 30px;">
                          <h2 style="margin-bottom: 20px; color: black;">🎉 ¡Juego terminado!</h2>
                          <p style="font-size: 1.2em; color: black;">Tu puntaje es: <strong>${score}</strong></p>
                          <p style="font-size: 1.2em; color: black;">Ingresa tu nombre para guardar tu puntuación:</p>
